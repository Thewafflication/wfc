...
This requirement applies to the WFC compatibility implementation of the `Form` class on supported Windows targets.

## Requirement

The WFC `Form` class shall expose the properties, methods, and events
...
| Reference CLSID | `{33AD4F38-6699-11CF-B70C-00AA0060D393}` |
| Default interface | `_Form`, `{33AD4F39-6699-11CF-B70C-00AA0060D393}` |
| Default event interface | `FormEvents`, `{33AD4F3A-6699-11CF-B70C-00AA0060D393}` |
...
| `MaxButton` | Get | `Boolean` | 65574 | — |
| `MDIChild` | Get | `Boolean` | 65584 | — |
| `MinButton` | Get | `Boolean` | 65575 | — |
