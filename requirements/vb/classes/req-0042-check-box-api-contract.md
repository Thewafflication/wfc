# REQ-0042 — VB CheckBox API contract
...
This requirement applies to the WFC compatibility implementation of the `CheckBox` class on supported Windows targets.

## Requirement

The WFC `CheckBox` class shall expose the properties, methods, and events
...
| Reference CLSID | `{33AD4EF8-6699-11CF-B70C-00AA0060D393}` |
| Default interface | `_CheckBox`, `{33AD4EF9-6699-11CF-B70C-00AA0060D393}` |
| Default event interface | `CheckBoxEvents`, `{33AD4EFA-6699-11CF-B70C-00AA0060D393}` |
...
| `Appearance` | Get/Let | `Integer` | 65570 | — |
| `BackColor` | Get/Let | `Long` | 65539 | — |
| `Caption` | Get/Let | `String` | 65537 | — |
| `CausesValidation` | Get/Let | `Boolean` | 65581 | — |
| `Container` | Get/Set | `Object` | 65571 | — |
| `DataChanged` | Get/Let | `Boolean` | 65566 | — |
| `DataField` | Get/Let | `String` | 65565 | — |
| `DataFormat` | Get/Set | `IStdDataFormatDisp` | 65583 | — |
| `DataMember` | Get/Let | `String` | 65582 | — |
| `DataSource` | Get/Set | `DataSource` | 65584 | — |
| `DisabledPicture` | Get/Let/Set | `Picture` | 65575 | — |
| `DownPicture` | Get/Let/Set | `Picture` | 65576 | — |
| `DragIcon` | Get/Let/Set | `Picture` | 65558 | — |
| `DragMode` | Get/Let | `Integer` | 65557 | — |
| `Enabled` | Get/Let | `Boolean` | 65545 | — |
| `Font` | Get/Set | `Font` | 65568 | — |
...
| `UseMaskColor` | Get/Let | `Boolean` | 65580 | — |
| `Value` | Get/Let | `Integer` | 65555 | — |
| `Visible` | Get/Let | `Boolean` | 65546 | — |
| `WhatsThisHelpID` | Get/Let | `Long` | 65569 | — |
...
| `Validate` | `ByRef Cancel: Boolean` | 262161 |
