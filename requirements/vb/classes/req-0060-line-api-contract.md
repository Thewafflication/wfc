...
This requirement applies to the WFC compatibility implementation of the `Line` class on supported Windows targets.

## Requirement

The WFC `Line` class shall expose the properties, methods, and events
...
| Reference CLSID | `{33AD4F88-6699-11CF-B70C-00AA0060D393}` |
| Default interface | `_Line`, `{33AD4F89-6699-11CF-B70C-00AA0060D393}` |
...
| `BorderColor` | Get/Let | `Long` | 65538 | — |
| `BorderStyle` | Get/Let | `Integer` | 65547 | — |
| `BorderWidth` | Get/Let | `Integer` | 65548 | — |
| `Container` | Get/Set | `Object` | 65549 | — |
| `DrawMode` | Get/Let | `Integer` | 65546 | — |
| `Index` | Get | `Integer` | 65537 | — |
| `Name` | Get | `String` | 65536 | — |
| `Parent` | Get | `Form` | 65544 | — |
| `Tag` | Get/Let | `String` | 65545 | — |
| `Visible` | Get/Let | `Boolean` | 65543 | — |
| `X1` | Get/Let | `Single` | 65539 | — |
| `X2` | Get/Let | `Single` | 65541 | — |
| `Y1` | Get/Let | `Single` | 65540 | — |
| `Y2` | Get/Let | `Single` | 65542 | — |
...
| `Drag` | `: Variant optional` | `HRESULT` | 131077 | Hidden |
