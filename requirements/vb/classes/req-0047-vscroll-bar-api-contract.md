# REQ-0047 — VB VScrollBar API contract
...
This requirement applies to the WFC compatibility implementation of the `VScrollBar` class on supported Windows targets.

## Requirement

The WFC `VScrollBar` class shall expose the properties, methods, and events
...
| Reference CLSID | `{33AD4F20-6699-11CF-B70C-00AA0060D393}` |
| Default interface | `_VScrollBar`, `{33AD4F21-6699-11CF-B70C-00AA0060D393}` |
| Default event interface | `VScrollBarEvents`, `{33AD4F22-6699-11CF-B70C-00AA0060D393}` |
