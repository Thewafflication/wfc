# REQ-0088 — VBA VbAppWinStyle values
...
This requirement applies wherever VBA exposes the `VbAppWinStyle` constants.
...
| --- | ---: | ---: |
| `vbHide` | `0` | 1073741824 |
| `vbNormalFocus` | `1` | 1073741825 |
| `vbMinimizedFocus` | `2` | 1073741826 |
| `vbMaximizedFocus` | `3` | 1073741827 |
| `vbNormalNoFocus` | `4` | 1073741828 |
| `vbMinimizedNoFocus` | `6` | 1073741829 |
