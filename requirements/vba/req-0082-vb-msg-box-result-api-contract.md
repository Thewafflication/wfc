# REQ-0082 — VBA VbMsgBoxResult values
...
This requirement applies wherever VBA exposes the `VbMsgBoxResult` constants.
...
| --- | ---: | ---: |
| `vbOK` | `1` | 1073741824 |
| `vbCancel` | `2` | 1073741825 |
| `vbAbort` | `3` | 1073741826 |
| `vbRetry` | `4` | 1073741827 |
| `vbIgnore` | `5` | 1073741828 |
| `vbYes` | `6` | 1073741829 |
| `vbNo` | `7` | 1073741830 |
