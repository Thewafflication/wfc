# REQ-0086 — VBA VbFirstWeekOfYear values
...
This requirement applies wherever VBA exposes the `VbFirstWeekOfYear` constants.
...
| --- | ---: | ---: |
| `vbUseSystem` | `0` | 1073741824 |
| `vbFirstJan1` | `1` | 1073741825 |
| `vbFirstFourDays` | `2` | 1073741826 |
| `vbFirstFullWeek` | `3` | 1073741827 |
