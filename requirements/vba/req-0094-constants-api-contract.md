...
**References:** `evidence/reference/vba-6.0-type-library.json`; `TC-MP0002-vba-string-constants-cli` and the constant unit tests verify the exposed members (`REQ-0179`).
