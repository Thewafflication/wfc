...
for the deferred `Rnd` return type. Complete Variant overloads (arrays,
objects, and error values) and runtime type information beyond
`TypeName`/`VarType` remain pending.
