# REQ-0089 — VBA VbCompareMethod values
...
This requirement applies wherever VBA exposes the `VbCompareMethod` constants.
...
| --- | ---: | ---: |
| `vbBinaryCompare` | `0` | 1073741824 |
| `vbTextCompare` | `1` | 1073741825 |
| `vbDatabaseCompare` | `2` | 1073741826 |
