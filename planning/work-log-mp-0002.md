...
- multi-dimensional arrays, array-typed parameters, and `Variant`/
  `Object`-element (dynamic or fixed) arrays -- the three largest items
  still deliberately excluded from `REQ-0201`/`REQ-0207`/`REQ-0208`/
  `REQ-0209`'s scope; `Erase` and `For Each` are now implemented;
